# Sourced — Agent Conventions (Antigravity/Gemini)


This file mirrors `/CLAUDE.md` so both agents work from identical rules.
If you edit one, edit the other to match.
