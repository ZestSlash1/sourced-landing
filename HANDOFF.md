...
- Wire n8n workflow credentials or test automated weekly drop drafting via `runDraftPass()`.
- Review newly formed clusters and draft pending idea drops for review in `/admin/pending`.
